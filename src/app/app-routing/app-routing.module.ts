...
export const pathLocationStrategyFactory = (_platformLocation: PlatformLocation) => {
  ...
  return window["loadInFriendlyIframe"] || window["parent"]["loadInFriendlyIframe"] ? new VoidPathLocationStrategy(_platformLocation) : new PathLocationStrategy(_platformLocation);
};
