    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (params) => {
          ...
          return `<div class="kLiveGraphTooltip"><span class="kHeader">${title}</span><div class="kUsers"><span class="kBullet" style="background-color: #d48d2b"></span>${this._translate.instant('app.entryLive.activeUsers')}&nbsp;${active.data}%</div><div class="kUsers"><span class="kBullet" style="background-color: #e0313a"></span>${this._translate.instant('app.entryLive.engagedUsers')}&nbsp;${engaged.data} Kbps</div></div>`;
        }
      },
      xAxis: {
        boundaryGap: false,
