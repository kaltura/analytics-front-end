...
import { DateRangeServerValue } from '../live-discovery/filters/filters.service';

export class LiveDiscoveryTableRequestFactory implements RequestFactory<KalturaMultiRequest, KalturaMultiResponse>, OnPollTickSuccess {
