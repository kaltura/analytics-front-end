...
@Component({
  selector: 'app-document-syndication',
  templateUrl: './syndication.component.html',
  styleUrls: ['./syndication.component.scss'],
  providers: [
    KalturaLogger.createLogger('DocumentSyndicationComponent'),
    ReportService,
    SyndicationDataConfig,
  ]
})
export class DocumentSyndicationComponent implements OnDestroy {
