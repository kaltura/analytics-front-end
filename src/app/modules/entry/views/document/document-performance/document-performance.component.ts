...
import { DocumentPerformanceConfig } from './document-performance.config';
...
@Component({
  selector: 'app-document-entry-performance',
  templateUrl: './document-performance.component.html',
  styleUrls: ['./document-performance.component.scss'],
  providers: [DocumentPerformanceConfig, ReportService]
})
