...
@Component({
  selector: 'app-document-devices',
  templateUrl: './devices-overview.component.html',
  styleUrls: ['./devices-overview.component.scss'],
  providers: [
    KalturaLogger.createLogger('DocumentDevicesComponent'),
    DevicesOverviewConfig,
    ReportService,
  ]
})
export class DocumentDevicesComponent extends QueryBase implements OnInit, OnDestroy {
  ...
  protected _loadReport(): void {
    ...
    this._reportType = reportTypeMap(KalturaReportType.documentEntryPlatforms);
