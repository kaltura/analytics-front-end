...
import { DocumentGeoComponent } from './geo/geo.component';
...
@Component({
  selector: 'app-document-top-countries',
  templateUrl: './top-countries.component.html',
  styleUrls: ['./top-countries.component.scss'],
  providers: [TopCountriesConfig, ReportService]
})
export class DocumentTopCountriesComponent extends QueryBase implements OnInit, OnDestroy {
  @Input() categoryId: string = null;
  @Input() playlistId: string = null;
  @Input() entryId: string = null;

  @ViewChild('categoryGeo') _categoryGeo: DocumentGeoComponent;
  @ViewChild('categoryCompareGeo') _categoryCompareGeo: DocumentGeoComponent;
  ...
  @Input() _distributionCalculationKey = 'count_document_impression';
  ...
  protected _componentId = 'top-document-geo';
  ...
  public _reportType = reportTypeMap(KalturaReportType.documentEntryMapOverlayCountry);
  ...
  public _onDrillDown(event: { drillDown: string[], reload: boolean }): void {
    ...
    this._reportType = this._drillDown.length === 2 ? reportTypeMap(KalturaReportType.documentEntryMapOverlayCity) : this._drillDown.length === 1 ? reportTypeMap(KalturaReportType.documentEntryMapOverlayRegion) : reportTypeMap(KalturaReportType.documentEntryMapOverlayCountry);
