...
export class EntryViewComponent implements OnInit, OnDestroy {
      ...
      new BaseEntryGetAction({ entryId: this._entryId })
        .setRequestOptions({
          responseProfile: new KalturaDetachedResponseProfile({
            ...
            fields: 'id,name,mediaType,createdAt,msDuration,userId,thumbnailUrl,displayInSearch,type'
          })
        }),
  ...
  public _navigateToDocument(): void {
    if (analyticsConfig.isHosted) {
      this._frameEventManager.publish(FrameEvents.NavigateTo, '/content/documents/document/' + this._entryId);
    }
  }
}
