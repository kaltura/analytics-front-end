...
@Component({
  selector: 'app-category-insight-geo',
  templateUrl: './insight-geo.component.html',
  styleUrls: ['./insight-geo.component.scss'],
  providers: [
    KalturaLogger.createLogger('InsightGeoComponent'),
    InsightGeoConfig,
    ReportService
  ]
})
export class InsightGeoComponent extends CategoryBase implements OnDestroy, OnInit {
  protected _componentId = 'insight-geo';
