...
import { CategoryGeoComponent } from './geo/geo.component';
...
@Component({
  selector: 'category-top-countries',
  templateUrl: './top-countries.component.html',
  styleUrls: ['./top-countries.component.scss'],
  providers: [TopCountriesConfig, ReportService]
})
export class CategoryTopCountriesComponent extends CategoryBase implements OnInit, OnDestroy {
  @Input() categoryId = '';
  
  @ViewChild('categoryGeo', { static: false }) _categoryGeo: CategoryGeoComponent;
  @ViewChild('categoryCompareGeo', { static: false }) _categoryCompareGeo: CategoryGeoComponent;
