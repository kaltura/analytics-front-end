...
@Component({
  selector: 'app-category-mini-highlights',
  templateUrl: './mini-highlights.component.html',
  styleUrls: ['./mini-highlights.component.scss'],
  providers: [
    KalturaLogger.createLogger('CategoryMiniTHighlightsComponent'),
    MiniHighlightsConfig,
    ReportService,
  ]
})
export class CategoryMiniHighlightsComponent extends CategoryBase {
