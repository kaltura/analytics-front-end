...
@Component({
  selector: 'app-manual-playlist-mini-top-videos',
  templateUrl: './mini-top-videos.component.html',
  styleUrls: ['./mini-top-videos.component.scss'],
  providers: [
    KalturaLogger.createLogger('MiniManualPlaylistTopVideosComponent'),
    MiniTopVideosConfig,
    ReportService
  ]
})
export class MiniManualPlaylistTopVideosComponent extends ManualPlaylistBase implements OnDestroy, OnInit {
  protected _componentId = 'manual-playlist-mini-top-videos';
