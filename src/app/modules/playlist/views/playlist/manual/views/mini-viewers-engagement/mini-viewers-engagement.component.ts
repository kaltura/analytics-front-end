...
import { MiniViewersEngagementConfig } from './mini-viewers-engagement.config';
...
@Component({
  selector: 'app-manual-playlist-mini-viewers-engagement',
  templateUrl: './mini-viewers-engagement.component.html',
  styleUrls: ['./mini-viewers-engagement.component.scss'],
  providers: [
    KalturaLogger.createLogger('ManualPlaylistMiniViewersEngagementComponent'),
    MiniViewersEngagementConfig,
    ReportService,
  ]
})
export class ManualPlaylistMiniViewersEngagementComponent extends ManualPlaylistBase {
  ...
  constructor(private _frameEventManager: FrameEventManagerService,
              ...
              private _dataConfigService: MiniViewersEngagementConfig,
