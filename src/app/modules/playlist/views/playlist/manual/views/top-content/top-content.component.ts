...
@Component({
  selector: 'app-manual-playlist-top-content',
  templateUrl: './top-content.component.html',
  styleUrls: ['./top-content.component.scss'],
  providers: [
    KalturaLogger.createLogger('ManualPlaylistTopContentComponent'),
    TopContentDataConfig,
    ReportService
  ]
})
export class ManualPlaylistTopContentComponent extends ManualPlaylistBase implements OnInit, OnDestroy {
