...
import { PathPerformanceConfig } from './path-performance.config';
...
@Component({
  selector: 'app-path-performance',
  templateUrl: './path-performance.component.html',
  styleUrls: ['./path-performance.component.scss'],
  providers: [PathPerformanceConfig, ReportService]
})
  ...
  public _onCompareTo(field: string): void {
    if (field) {
      ...
      this._metricsLineChartData = this._compareService.compareToMetric(
        ...
        this._translate.instant(`app.playlist.${field}`),
