...
import { EndedPollsService } from './ended-polls.service';
import { ReportHelper, ReportService } from 'shared/services';
import { cancelOnDestroy } from '@kaltura-ng/kaltura-common';
import { analyticsConfig } from 'configuration/analytics-config';
import { EndedRequestFactory } from './ended-request-factory';
...
import { EndedDataConfig } from './ended-data.config';
...
@Injectable()
export class EndedService implements OnDestroy {
  ...
  private _pollsFactory = new EndedRequestFactory();
  private _firstTimeLoading = true;

  public readonly data$ = this._data.asObservable();
  public readonly state$ = this._state.asObservable();

  constructor(private _serverPolls: EndedPollsService,
              private _reportService: ReportService,
              private _kalturaClient: KalturaClient,
              private _dataConfigService: EndedDataConfig,
                ...
                new BaseEntryListAction({
                  ...
                  new KalturaRequestOptions({
                    responseProfile: new KalturaDetachedResponseProfile({
                      ...
                      fields: 'id,name,thumbnailUrl,status,liveStatus,mediaType,createdAt,currentBroadcastStartTime,lastBroadcastEndTime,userId,creatorId'
                    })
                  })
                )
              )
