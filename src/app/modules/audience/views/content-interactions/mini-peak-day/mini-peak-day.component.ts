...
@Component({
  selector: 'app-interactions-mini-peak-day',
  templateUrl: './mini-peak-day.component.html',
  styleUrls: ['./mini-peak-day.component.scss'],
  providers: [
    KalturaLogger.createLogger('InteractionsMiniPeakDayComponent'),
    MiniPeakDayConfig,
    ReportService,
  ]
})
export class InteractionsMiniPeakDayComponent extends InteractionsBaseReportComponent {
